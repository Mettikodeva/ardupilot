...
#define HAL_ESP32_BOARD_NAME "esp32-nara"
...
//I2C Buses
#define HAL_ESP32_I2C_BUSES {.port=I2C_NUM_0, .sda=GPIO_NUM_21, .scl=GPIO_NUM_22, .speed=400*KHZ, .internal=true, .soft=false}
...
//RCOUT
#define HAL_ESP32_RCOUT {GPIO_NUM_25, GPIO_NUM_26, GPIO_NUM_37, GPIO_NUM_32, GPIO_NUM_33, GPIO_NUM_14}
